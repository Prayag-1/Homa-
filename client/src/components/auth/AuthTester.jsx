          ...
          <div className="space-y-6">
            <FieldGroup title="1. Register">
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <Input label="Phone Number" name="phoneNumber" value={registerData.phoneNumber} onChange={setField(setRegisterData)} placeholder="International phone number" />
            ...
            <FieldGroup title="2. Verify phone">
              <div className="grid gap-4 md:grid-cols-2">
                <Input label="Phone Number" name="phoneNumber" value={verifyData.phoneNumber} onChange={setField(setVerifyData)} placeholder="International phone number" />
            ...
            <FieldGroup title="3. Login">
              <div className="grid gap-4 md:grid-cols-2">
                <Input label="Phone Number" name="phoneNumber" value={loginData.phoneNumber} onChange={setField(setLoginData)} placeholder="International phone number" />
