...
const navClass =
  "relative font-body text-sm font-medium text-homa-black transition-colors duration-200 hover:text-homa-red";
const iconClass =
...
function ActiveDot({ active }) {
  ...
  return (
    <span
      className="mx-auto mt-0.5 block h-1 w-1 rounded-full bg-homa-red"
      aria-hidden="true"
    />
  );
}
      ...
      <motion.header
        ...
        animate={{
          ...
          borderBottomColor: isTop
            ...
            : "rgba(209, 0, 0, 0.1)",
          boxShadow: isTop
            ? "0 0 0 rgba(209, 0, 0, 0)"
            : "0 1px 20px rgba(209, 0, 0, 0.06)",
        }}
          ...
          <nav className="hidden items-center gap-8 md:flex">
            ...
            <div ref={moreRef} className="relative">
              ...
              >
                ...
                <ActiveDot
                  active={moreLinks.some((link) => isActive(link.to))}
                />
              </button>
